...
def db():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS result(rid INTEGER PRIMARY KEY AUTOINCREMENT,roll text,name text,course text,marks_obtained text,total_marks text,percentage text)")
    con.commit()
